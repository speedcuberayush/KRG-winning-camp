    ...
    def execute_process(self):
        while not self.exit_flag:
            ...
            if self.running_process:
                result, instruction = self.running_process.execute_instruction()
                if result == "EXECUTED":
                    print(f"Process {self.running_process.pid} executing : {instruction}")
...
if __name__ == "__main__":
    process_list = [
        Process(1, ["$$$$", "instr2", "$$$$", "instr3"], priority=1),
        Process(2, ["$$$$", "$$$$", "instr2", "instr3"], priority=2),
        Process(3, ["$$$$", "instr2", "instr3"], priority=1),
        Process(4, ["$$$$", "$$$$", "instr2"], priority=3),
        Process(5, ["$$$$", "instr2"], priority=2),
        Process(6, ["$$$$", "instr2", "$$$$", "instr3"], priority=3),
]
